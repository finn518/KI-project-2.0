...
const Register = () => {
  return (
    <div className='flex flex-col gap-8 items-center justify-center h-screen'>
        <h2 className='underline underline-offset-[20px] text-4xl font-bold mb-2'>Register</h2>
        ...
        <div className='relative flex flex-row items-center border-b-2'>
            <input type="text" placeholder='Email' className='pl-10 pr-3 py-2 w-96 focus:outline-none border-none bg-transparent'/>
            <img src={person} alt="person" className='size-6 absolute ml-2'/>
        </div>
        ...
        <p>Already have an account? <a href="#" className='font-bold'>Sign In</a></p>

        <button className='bg-slate-500 font-semibold w-52 h-12 rounded-md text-white'>Sign Up</button>
    </div>
  )
}
